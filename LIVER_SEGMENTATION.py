...
# You may choose which method to use. Local method is used in the written code, but with coordinates that works as global region growing ([-1, 0, 1]). To use modified local method, change the coordinates in line 44
